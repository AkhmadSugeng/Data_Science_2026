...
Untuk Mata Kuliah Data Science_ Informatika_Universitas Siber Asia
...
Tentang Saya & Tujuan Belajar:

Hallo! Saya adalah mahasiswa Program Studi Informatika di Universitas Siber Asia. Repositori ini saya rancang sebagai ruang dokumentasi digital, portofolio tugas, sekaligus ruang eksperimen praktis sepanjang perjalanan saya mendalami ranah Data Science.

Ketertarikan saya pada Data Science didorong oleh keinginan untuk menguasai kompetensi mutakhir yang memadukan matematika-statistika, keahlian pemrograman, dan pemahaman konteks bisnis. Di tengah masifnya pertumbuhan Big Data saat ini, tujuan utama saya adalah mengasah kemampuan mengolah berbagai karakteristik data, baik terstruktur maupun tidak terstruktur agar mampu mengekstrak insight tersembunyi, membangun model prediktif yang akurat, serta menyajikan rekomendasi berbasis data yang berdampak nyata bagi pengambilan keputusan strategis.
...
| :---: | :--- | :--- |
| **01** | Pengenalan Data Science | [Buka Notebook](./Pertemuan_01_Akhmad_Sugeng_Saputro_240401010142.ipynb) |
...
```bash
   git clone [https://github.com/akhmadsugeng/data-science-2026.git](https://github.com/akhmadsugeng/data-science-2026.git)
...
### Opsi B: Menjalankan Menggunakan Google Colab
    ...
    Masukkan URL repository Anda: https://github.com/AkhmadSugeng/Data_Science_2026 lalu tekan tombol pencarian (Enter).
